...
class Way2enjoyweb {
    ...
    public function url($opts = array()) {
        ...
        $response = self::request($data, 'http://way2enjoy.com/modules/compress-png/webapi/apicompressorweb.php', 'url');
//print_r($data);
...
//print_r($data);
        ...
        $response = self::request($data, 'http://way2enjoy.com/modules/compress-png/webapi/apicompressorweb.php', 'upload');
    ...
    public function status() {
        ...
        $response = self::request(json_encode($data), 'http://way2enjoy.com/modules/compress-png/webapi/apicompressorweb.php', 'url');
